...
public class ResponseUtils {
	...
	public static <T> Response<T> returnSuccess() {
		return new Response(true, ResponseCode.SUCCESS.getCode(), ResponseCode.SUCCESS.getShowMsg(), "", null);
	}
	...
	public static <T> Response<T> returnObjectSuccess(T t) {
		if (t == null) {
			...
			return new Response(true, ResponseCode.SUCCESS.getCode(), ResponseCode.SUCCESS.getShowMsg(), "", t);
		}
	}
	...
	public static <T> Response<T> returnListSuccess(Collection<?> collection) {
		if (collection == null) {
			return new Response(true, ResponseCode.SUCCESS.getCode(), ResponseCode.SUCCESS.getShowMsg(), "", new ArrayList());
		} else {
			return new Response(true, ResponseCode.SUCCESS.getCode(), ResponseCode.SUCCESS.getShowMsg(), "", collection);
		}
	}
	...
	public static <T> Response<T> returnException(Exception e) {
		if (e instanceof BusinessException) {
			...
			return new Response<T>(false, ResponseCode.VALIDATE_EXCEPTION.getCode(), ResponseCode.VALIDATE_EXCEPTION.getShowMsg(), ll.getMessage() + " [Exception]:" + e, null);
		} else if (e instanceof MissingServletRequestParameterException) {
			MissingServletRequestParameterException msrp = (MissingServletRequestParameterException) e;
			return new Response<T>(false, ResponseCode.VALIDATE_EXCEPTION.getCode(), ResponseCode.VALIDATE_EXCEPTION.getShowMsg(), msrp.getMessage() + " [Exception]:" + e, null);
		} else {
			return new Response<T>(false, ResponseCode.SYS_EXCEPTION.getCode(), ResponseCode.SYS_EXCEPTION.getShowMsg(), ResponseCode.SYS_EXCEPTION.getErrorMsg() + " [Exception]:" + e, null);
		}
	}
